...
- Add icons chrome (as in DeepThought `icons` directory) <23-03-24> 
...
- Add a shortcode for linking sites and linking page see `sass/_anchors.scss`  <21-03-24> 
- Change the /resources/og_image.png to some my image <20-03-24> 
- Change colors to https://github.com/Speyll/veqev <19-03-24> 
- https://www.hostinger.com/tutorials/website-color-schemes <23-03-24> 
- Book recommendation section in the about and link to their Goodreads reviews
- Take inspiration here: https://dharmx.is-a.dev/
    - Side navigation
    - Hiding TOC
    - `details`
    - Nice search
...
- In-front of "nav home button", put the icon of the site instead of the "home" icon
